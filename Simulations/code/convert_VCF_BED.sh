...
print_help()
{
	...
	printf 'Usage: %s [-o|--optimum <arg>] [-s|--selectcoeff <arg>] [-f|--frequency <arg>] [-d|--directory <arg>] [-h|--help]\n' "$0"
...
for file in $( ls ${folder}*.vcf.gz )
do
    echo "Converting ${file}..."
    filename=$(echo $file | sed -e 's/.vcf.gz//g' )
    plink1.9 --vcf $file --make-bed --out $filename
done
